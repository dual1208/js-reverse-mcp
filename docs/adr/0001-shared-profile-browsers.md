...
- All Chrome browser instances use the same installed `/Applications/Google Chrome.app` bundle and executable. Profile-specific copies, renamed browser bundles, alternate Chrome products, and re-signed Chrome variants are excluded. Distinguishing Cesar and Tyson in macOS must preserve this invariant. The icon mechanism remains under [separate investigation](../research/macos-app-switcher-apple-evidence.md).
